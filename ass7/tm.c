...
char *versionNumber =(char *)"TM version 4.5b";
...
STEPRESULT stepTM(void)
{
    ...
    // values in r5 and r6.   Memory is scheckedfrom high address
    // to low!
    case opCO: {
        int raddr, saddr;
	int i;
